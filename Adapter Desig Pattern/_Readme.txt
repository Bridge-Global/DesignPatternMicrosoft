...
(incompatible) interface of a class (Adaptee) into another interface (Target)
 clients require.
...
.
In the adhaar database the fields name are different than our local database
 so we create an Adapter class called AdhaarAdapter which
will convert the Adhaar customer data structure into our local database local structure
. 
